*Pattern Recognition*
  - Course: 
  - Instructor: [Pooran Singh Negi][https://sites.google.com/site/poorannegi/], pooran.negi@gmail.com
  - Office: 
  - Office Hours: After the class T, Th,  12.00 - 1.50 p.m. Email for 1-on-1 help.
* Prerequisite
Student should be comfortable with linear algebra, probability, statistics,
optimization and  programming experience in python and its scientif libraries. We will cover some basics in the class.
...
|  1 | Chapter 2, 2.1(use bayes rule, condition on event actually observed. like in part a say N_b = number of boys, N_b no of girls), 2.3, 2.6, 2.12 |          |     |
...
|---------+--------------------------------+-----------------|
| 19 June | Read chapter 1 of Kevin Murphy |                 |
|---------+--------------------------------+-----------------|
|         |                                |                 |
