...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----+----+------------------------------------------+-----+---|
|                                                                                                                                                                                                                        |    |    |                                          |     |   |
| *coding part*:  [[file:hws/hw1_python_numpy_matplotlib.ipynb][python_numpy_matplotlib]]                                                                                                                                                                                |  1 | 1a | 29 June 11.59 p.m                        | [[./hws/hw1_python_numpy_matplotlib_solutions.ipynb][sol]] |   |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----+----+------------------------------------------+-----+---|
| *written part*: Problem numbers are from kevin murphy book. *Use DU  library version*.                                                                                                                                 |    | 1b |                                          |     |   |
| submit written solution: Chapter 2, 2.1(use bayes rule, condition on event actually observed.                                                                                                                          |  1 |    | 28 June in class                         | [[./hws/HW1_sol.pdf][sol]] |   |
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----+----+------------------------------------------+-----+---|
| Chpater 2,    2.13 (3 point, hint: I(X,Y) = H(X) + H(Y) - H(X,Y))                                                                                                                                                      |  2 | 2a | 6 th July at 3 p.m in office 470         |     |   |
| chapter 3,    3.6 (4 point), 3.7(2 point each), 3.11(1 point each), 3.20(1 point each),                                                                                                                                |    |    |                                          |     |   |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----+----+------------------------------------------+-----+---|
| [[./hws/implementing_naive_bayes.ipynb][implementing naive bayes ham or spam for sms]]                                                                                                                                                                           |  2 | 2b | 9 th July online                         |     |   |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----+----+------------------------------------------+-----+---|
| - Prove that If $\Sigma_c$ (covaraince matrix for class c) is diagonal, than Gaussian discriminant analysis equivalent to naive Bayes                                                                                  |    |    |                                          |     |   |
| - Use equation 4.43($\mathbf{x}^T(\mathbf{\beta_c - \beta_{c^{'}} } =\gamma_c -\gamma_{c^{'}})$) from the book and show that decision boundary is perpendicular to the line connecting two mean $\mu_c$ and $\mu_{c^'}$ |    |    |                                          |     |   |
| 4.1 (1 point )(look into section 2.5.1 for definition of correlation coefficient), 4.14(4 point 1+1+1+1 point each)                                                                                                    |  3 |    |                                          |     |   |
| 4.21(4 = 2 + 2 point ), 4.22(2 = 1+1 point), 5.2(4= 2+2 points), 5.3(4= 2+2 points)                                                                                                                                    |    |    | 13 th July Friday at 3 p.m in office 470 |     |   |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----+----+------------------------------------------+-----+---|
|                                                                                                                                                                                                                        |    |    |                                          |     |   |
