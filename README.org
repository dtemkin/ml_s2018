...
|---------------------------------------------------------------------------------------------------------+----+--------------------+-----|
|                                                                                                         |    |                    |     |
| *coding part*:  [[file:hws/hw1_python_numpy_matplotlib.ipynb][python_numpy_matplotlib]]                                                                 | 1a | 29 June 11.59 p.m  |     |
|---------------------------------------------------------------------------------------------------------+----+--------------------+-----|
| *written part*: Problem numbers are from kevin murphy book. *Use DU  library version*.                  | 1b |                    |     |
| submit written solution: Chapter 2, 2.1(use bayes rule, condition on event actually observed.           |    | 28 June in class   |     |
...
|---------------------------------------------------------------------------------------------------------+----+--------------------+-----|
| Chpater 2,    2.13 (3 point)                                                                            | 2a | 5 th July in class |     |
