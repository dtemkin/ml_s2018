...
|----+----+-------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------+-----+---|
|    |    | - Prove that If $\sigma_c$ (covrance matrix for class c) is diagonal, than Gaussian discriminant analysis equivalent to naive Bayes |                                          |     |   |
|  3 |    | 4.1 (1 point )(look into section 2.5.1 for definition of correlation coefficient), 4.14(4 point 1+1+1+1 point each)                 |                                          |     |   |
