...
|----+----------------------+---------------------------------------------------------------------------------------------------------+-----|
|    |                      |                                                                                                         |     |
|  1 | 29 June 11.59 p.m    | *coding part*:  [[./hws/hw1_python_numpy_matplotlib.ipynb][python_numpy_matplotlib]]                                                                 |     |
|    | for coding part      | *written part*: Problem numbers are from kevin murphy book. *Use DU  library version*.                  |     |
|    | and 28 June in class | submit written solution: Chapter 2, 2.1(use bayes rule, condition on event actually observed.           |     |
