...
|----+----------------------+---------------------------------------------------------------------------------------------------------+-----|
|    |                      |                                                                                                         |     |
| 1a | 29 June 11.59 p.m    | *coding part*:  [[./hws/hw1_python_numpy_matplotlib.ipynb][python_numpy_matplotlib]]                                                                 |     |
|----+----------------------+---------------------------------------------------------------------------------------------------------+-----|
|    |                      | *written part*: Problem numbers are from kevin murphy book. *Use DU  library version*.                  |     |
| 1b | 28 June in class     | submit written solution: Chapter 2, 2.1(use bayes rule, condition on event actually observed.           |     |
|    |                      | like in part a say N_b = number of boys, N_b no of girls) (4 = 2+2 point), 2.3 (2 point), 2.4(2 point), |     |
